...
You rarely need to edit `.syllago.yaml` by hand. Syllago generates and maintains it automatically when you [`create`](/syllago-docs/using-syllago/cli-reference/create/), `add`, or sync content.
