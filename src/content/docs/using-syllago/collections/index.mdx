...
| Key commands | `add`, `import`, `list` | `registry add/sync/items` | `loadout create/apply/remove` |
...
Git-based repositories of shared content maintained by teams or the community. You consume registry content locally and can contribute back via pull request using `syllago promote to-registry`.
