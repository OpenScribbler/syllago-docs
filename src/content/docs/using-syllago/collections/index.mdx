...
Git-based repositories of shared content maintained by teams or the community. You consume registry content locally and can contribute back via pull request using `syllago share --to <registry>`.
...
[Registries deep-dive](/using-syllago/collections/registries/)
...
[Loadouts deep-dive](/using-syllago/collections/loadouts/)
