...
Your [library](/syllago-docs/using-syllago/collections/library/) stores individual content items. [Registries](/syllago-docs/using-syllago/collections/registries/) share content across teams. Loadouts sit on top of both — they bundle content from your library into apply-as-a-unit configurations.
...
- [Collections overview](/syllago-docs/using-syllago/collections/) — how library, registries, and loadouts work together
- [Library](/syllago-docs/using-syllago/collections/library/) — your personal content store
- [Registries](/syllago-docs/using-syllago/collections/registries/) — shared team and community content
- [CLI reference: loadout commands](/syllago-docs/using-syllago/cli-reference/loadout-apply/) — full flag and option details
