...
Supported by **8 of 12 providers**: Claude Code, Gemini CLI, Copilot CLI, Cursor, Windsurf, Codex, Cline, and Kiro.

## Canonical Format

Syllago uses a provider-neutral canonical format for hooks, defined by the [Hook Interchange Format Specification](/syllago-docs/reference/hooks-v1/).
...
- [Hook Interchange Format Specification](/syllago-docs/reference/hooks-v1/) — full canonical format specification
