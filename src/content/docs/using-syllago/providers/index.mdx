...
|----------|------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [Claude Code](/using-syllago/providers/claude-code/) | `claude-code` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 23 | stdio, sse, streamable-http |
| [Gemini CLI](/using-syllago/providers/gemini-cli/) | `gemini-cli` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 11 | stdio, sse |
| [Cursor](/using-syllago/providers/cursor/) | `cursor` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 7 | stdio, sse, streamable-http |
| [Windsurf](/using-syllago/providers/windsurf/) | `windsurf` | ✅ | ✅ | — | ✅ | ✅ | — | — | stdio, sse |
| [Codex](/using-syllago/providers/codex/) | `codex` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | — | stdio |
| [Copilot CLI](/using-syllago/providers/copilot-cli/) | `copilot-cli` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 8 | stdio, sse |
| [Zed](/using-syllago/providers/zed/) | `zed` | ✅ | — | — | ✅ | — | — | — | stdio |
| [Cline](/using-syllago/providers/cline/) | `cline` | ✅ | — | — | ✅ | ✅ | — | 8 | stdio, sse, streamable-http |
...
| [Kiro](/using-syllago/providers/kiro/) | `kiro` | ✅ | ✅ | ✅ | ✅ | ✅ | — | 5 | stdio, sse |
