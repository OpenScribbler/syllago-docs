...
When you've created content locally that you want to share back, use `syllago share` — pass `--to <registry>` to open a PR against a registry repo, or omit it to share directly with a default team repo:
