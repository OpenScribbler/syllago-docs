...
|----------|-------------|----------|
| [llms.txt](/syllago-docs/llms.txt) | Index of available documentation sets | Discovery |
| [llms-small.txt](/syllago-docs/llms-small.txt) | Condensed documentation | Quick context, smaller models |
| [llms-full.txt](/syllago-docs/llms-full.txt) | Complete documentation | Comprehensive understanding |
...
curl -s https://openscribbler.github.io/syllago-docs/llms-full.txt | pbcopy
