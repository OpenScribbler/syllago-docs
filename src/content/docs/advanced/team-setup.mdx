...
- [`syllago install`](/syllago-docs/using-syllago/cli-reference/install/) — installing content to providers
- [`syllago publish`](/syllago-docs/using-syllago/cli-reference/publish/) — contributing content to a registry
- [`syllago share`](/syllago-docs/using-syllago/cli-reference/share/) — contributing content to a team repo
