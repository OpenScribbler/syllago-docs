...
A [registry](/using-syllago/collections/registries/) is a git repo that holds shared syllago content. This is the primary mechanism for distributing team standards.
...
A [loadout](/using-syllago/collections/loadouts/) bundles multiple content items into a single apply-as-a-unit configuration. For team onboarding, this turns a multi-step manual setup into one command.
...
- [Registries](/using-syllago/collections/registries/) — full reference on adding, syncing, and browsing registries
- [Loadouts](/using-syllago/collections/loadouts/) — creating, applying, and managing loadouts
- [`syllago init`](/using-syllago/cli-reference/init/) — project initialization
