...
- [Registries](/syllago-docs/using-syllago/collections/registries/) — managing git-based registries
- [`syllago publish`](/syllago-docs/using-syllago/cli-reference/publish/) — contributing to registries
- [Team Setup](/syllago-docs/advanced/team-setup/) — configuring syllago for team use
