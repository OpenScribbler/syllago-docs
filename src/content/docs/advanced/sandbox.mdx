...
- [CLI reference: sandbox commands](/syllago-docs/using-syllago/cli-reference/sandbox/) — full flag and option details for all sandbox subcommands
- [CLI reference: sandbox run](/syllago-docs/using-syllago/cli-reference/sandbox-run/) — all flags for `sandbox run`
- [CLI reference: sandbox check](/syllago-docs/using-syllago/cli-reference/sandbox-check/) — prerequisite verification
