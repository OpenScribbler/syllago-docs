...
2. If the tool is installed but not detected, add it manually:
   ...
   ```
3. Run [`syllago providers`](/using-syllago/cli-reference/providers/) to see all supported providers.
...
**Fix:**
1. Check [`syllago providers`](/using-syllago/cli-reference/providers/) to see which content types each provider supports.
