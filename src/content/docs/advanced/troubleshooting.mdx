...
2. If the tool is installed but not detected, add it manually:
   ...
   ```
3. Run [`syllago info providers`](/using-syllago/cli-reference/info-providers/) to see all supported providers.
...
**Fix:**
1. Run [`syllago list`](/using-syllago/cli-reference/list/) to verify what's actually imported.
...
**Fix:**
1. Check [`syllago info providers`](/using-syllago/cli-reference/info-providers/) to see which content types each provider supports.
2. Not all content types work with all providers. Verify your source and target are compatible.
3. Check the [format conversion reference](/using-syllago/format-conversion/) for the compatibility matrix.

**Related error codes:**
- [CONVERT_001](/errors/convert-001/) — Conversion not supported
- [EXPORT_001](/errors/export-001/) — Export failed
...
3. Run sync with verbose output for details:
   ...
   ```
4. Check [`syllago registry list`](/using-syllago/cli-reference/registry-list/) to confirm the registry URL is correct.

**Related error codes:**
- [REGISTRY_001](/errors/registry-001/) — Registry not found
- [REGISTRY_002](/errors/registry-002/) — Registry sync failed
...
**Related error codes:**
- [INSTALL_001](/errors/install-001/) — Installation failed
...
See the full [error codes reference](/errors/) for the complete list.
...
- **CLI reference:** Browse the full [CLI reference](/using-syllago/cli-reference/) for detailed documentation.
